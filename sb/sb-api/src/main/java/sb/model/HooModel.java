...
/**
 * The base model interface for the Hoo service. Represents a row in the &quot;HOO_Hoo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link sb.model.impl.HooModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link sb.model.impl.HooImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface HooModel extends BaseModel<Hoo>, GroupedModel, ShardedModel,
	StagedAuditedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a hoo model instance should use the {@link Hoo} interface instead.
	 */
	...
	@Override
	public CacheModel<sb.model.Hoo> toCacheModel();
