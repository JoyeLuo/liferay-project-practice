...
/**
 * Provides the base implementation for the hoo remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link sb.service.impl.HooServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class HooServiceBaseImpl extends BaseServiceImpl
	implements HooService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link sb.service.HooServiceUtil} to access the hoo remote service.
	 */
	 ...
	 */
	public sb.service.HooLocalService getHooLocalService() {
	 ...
	 */
	public void setHooLocalService(sb.service.HooLocalService hooLocalService) {
		this.hooLocalService = hooLocalService;
	}

	/**
	 * Returns the hoo remote service.
	 *
	 * @return the hoo remote service
	 */
	public HooService getHooService() {
		return hooService;
	}

	/**
	 * Sets the hoo remote service.
	 *
	 * @param hooService the hoo remote service
	 */
	public void setHooService(HooService hooService) {
		this.hooService = hooService;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HooService.class.getName();
	}
	...
	@BeanReference(type = sb.service.HooLocalService.class)
	protected sb.service.HooLocalService hooLocalService;
	@BeanReference(type = HooService.class)
	protected HooService hooService;
